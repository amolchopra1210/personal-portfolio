...
const Work = () => {
  return (
    <div name="work" className="w-full md:h-screen text-gray-300 bg-[#0a192f] pb-[100px]">
            ...
            <div className="opacity-0 text-center group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a href="/">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    <a
                      href="https://react-admin-dashboard-amolchopra1210.vercel.app/"
                      target="_blank"
                      rel="noreferrer"
                    >
                      Link
                ...
                <a href="/">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    <a
                      href="https://github.com/amolchopra1210/react-admin-dashboard"
                      target="_blank"
                      rel="noreferrer"
                    >
                      Code
